export default function Header() {
  return (
    <header className="text-center mb-14">
      ...
      <h1 className="text-5xl md:text-6xl font-semibold tracking-tight text-white/95">
        re<span className="text-white/40">:</span>convert
      </h1>

      <p className="mt-4 text-white/45 text-base md:text-lg max-w-md mx-auto leading-relaxed">
