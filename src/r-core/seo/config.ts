...
export const SEO_PAGES: SeoPageConfig[] = [
  // ============ IMAGES ============
  {
    ...
    intro:
      "HEIC is Apple's default photo format since iOS 11, but it's not widely supported. Convert HEIC to JPG for universal compatibility — right in your browser, without uploading files anywhere.",
    benefits: [
      "Works on Windows, Mac, Linux, Android — anywhere",
      "Uploads to Instagram, WhatsApp, email, editors",
  ...
  },
  {
    ...
    intro:
      "PNG is a lossless format that preserves every detail. Convert HEIC to PNG for editing without losing quality.",
    benefits: [
  ...
  },
  {
    ...
    intro:
      "JPG files are 60–80% smaller than PNG. Convert PNG to JPG to save storage, speed up websites, and send files faster.",
    benefits: [
  ...
  },
  {
    ...
    intro:
      "Convert JPG to PNG for lossless editing without further quality loss.",
    benefits: [
  ...
  },
  {
    ...
    to: "JPG",
    category: "images",
    description: "Convert WEBP images to JPG for universal compatibility.",
    keywords: ["webp to jpg", "webp to jpeg", "convert webp"],
    intro:
      "WEBP is modern but not universally supported. Convert WEBP to JPG for compatibility with older software.",
    benefits: [
      "Works everywhere — old and new devices",
      "Universal compatibility",
      "Adjustable quality",
      "Private — no uploads",
    ],
  ...
  },
  {
    ...
    intro:
      "Convert WEBP to PNG for lossless editing and transparency support.",
    benefits: [
      "Lossless conversion",
  ...
  },
  {
    ...
    to: "WEBP",
    category: "images",
    description: "Convert PNG to WEBP for smaller files without losing quality.",
    keywords: ["png to webp", "convert png to webp"],
    intro:
      "WEBP files are up to 35% smaller than PNG at similar quality. Perfect for websites.",
    benefits: [
      "Up to 35% smaller than PNG",
      "Faster websites",
      "Supports transparency",
      "Modern format",
    ],
  ...
  },
  {
    ...
    intro: "Convert JPG to WEBP to shrink your images for the web.",
    benefits: [
      "Smaller file sizes",
      "Modern format",
      "Fully browser-based",
  ...
  },
  {
    ...
    intro:
      "Create website favicons from PNG images. ICO format bundles multiple sizes in a single file.",
    benefits: [
      "Includes 16×16, 32×32, 48×48",
  ...
  },
  {
    ...
    intro:
      "AVIF is the newest image format — up to 50% smaller than JPG with better quality.",
    benefits: [
      "Next-gen compression",
      "Better than JPG and WEBP",
  ...
  },
  {
    ...
    intro:
      "Convert JPG to AVIF to shrink your photos dramatically while keeping quality.",
    benefits: [
  ...
  },
  {
    ...
    intro:
      "Convert SVG vector graphics to PNG for universal compatibility and easy editing.",
    benefits: [
      "Works everywhere — including social media",
  ...
  },
  {
    ...
    intro: "Convert the first frame of a GIF to PNG for lossless output.",
    benefits: [
      "Lossless output",
      "Smaller than GIF for static images",
      "Supports transparency",
      "Quick conversion",
    ],
    faq: [
  ...
  // ============ DATA ============
  {
    ...
    intro:
      "Convert JSON arrays to CSV for Excel, Google Sheets, or any spreadsheet software. All in your browser — no uploads, no data leaks.",
    benefits: [
  ...
  },
  {
    ...
    intro:
      "Convert CSV files to JSON arrays for APIs, web apps, and modern data pipelines.",
    benefits: [
  ...
  },
  {
    ...
    intro:
      "Convert JSON to YAML — the friendly format for configs (Kubernetes, CI/CD, Ansible).",
    benefits: [
      "Cleaner, more readable format",
      "Perfect for config files",
      "Supports comments",
      "Ready for Kubernetes, Docker, CI",
    ],
    faq: [],
  },
  {
    ...
    intro: "Convert YAML configs to JSON for APIs and web apps.",
    benefits: [
  ...
  },
  {
    ...
    intro:
      "Convert JSON to XML for legacy systems, SOAP APIs, or RSS feeds.",
    benefits: [
      "Standard XML output",
      "Pretty-printed",
      "Handles attributes",
  ...
  },
  {
    ...
    intro:
      "Convert XML to JSON for modern apps and APIs.",
    benefits: [
      "Modern JSON output",
  ...
  },
  {
    ...
    intro:
      "Convert JSON to TSV — perfect for data import into databases and analytics tools.",
    benefits: [
  ...
  },
  {
    ...
    intro:
      "Convert CSV to YAML for configuration files and modern data formats.",
    benefits: [
      "Clean YAML output",
      "Great for configs",
      "Readable format",
...

  {
    ...
    intro:
      "Convert PDF pages to high-resolution PNG images. Each page becomes a separate file — perfect for previews, presentations, and image editing.",
    benefits: [
      "High resolution (up to 3x)",
      "Multi-page support (ZIP output)",
      "Preserves quality",
      "Fully private",
    ],
    faq: [
  ...
  },
  {
    ...
    intro:
      "Convert PDF pages to JPG images. Smaller files than PNG — perfect for sharing.",
    benefits: [
      "Adjustable quality",
      "Multi-page → ZIP",
      "Smaller files",
  ...
  },
  {
    ...
    intro:
      "Convert PNG images to PDF documents. Choose A4, Letter, or fit-to-image.",
    benefits: [
      "Multiple page sizes",
      "Custom margins",
      "Preserves quality",
  ...
  },
  {
    ...
    intro:
      "Convert JPG images to PDF for easy sharing and printing.",
    benefits: [
      "Standard PDF output",
      "Multiple page sizes",
      "Fast conversion",
  ...
  },
  {
    ...
    to: "PDF",
    category: "pdf",
    description: "Convert any image (PNG, JPG, WEBP, HEIC) to PDF.",
    keywords: ["image to pdf", "photo to pdf", "convert image to pdf"],
    intro:
      "Convert any image — PNG, JPG, WEBP, HEIC — to PDF in one click.",
    benefits: [
      "Any image format",
...
export function getSeoPage(slug: string): SeoPageConfig | null {
  return SEO_PAGES.find((p) => p.slug === slug || p.url === slug) ?? null;
}
